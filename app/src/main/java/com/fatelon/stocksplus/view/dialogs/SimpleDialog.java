...
public class SimpleDialog {
    ...
    public static void showNewPortfolioDialogWithCallback(Context context, final DialogMultiResponse dialogMultiResponse) {
        final EditText input = new EditText(context);
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.MATCH_PARENT,
                LinearLayout.LayoutParams.MATCH_PARENT);
        input.setLayoutParams(lp);
        input.setHint(context.getResources().getString(R.string.portfolio_add_dialog_message));

        AlertDialog.Builder simpleDialog = new AlertDialog.Builder(context);
        simpleDialog.setTitle(context.getResources().getString(R.string.portfolio_add_dialog_title));
        simpleDialog.setMessage(context.getResources().getString(R.string.portfolio_add_dialog_message));
        simpleDialog.setView(input);
        simpleDialog.setNegativeButton(context.getResources().getString(R.string.add_stock_dialog_button_add), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                if (dialogMultiResponse != null) dialogMultiResponse.dialogMultiResponse(input.getText().toString());
